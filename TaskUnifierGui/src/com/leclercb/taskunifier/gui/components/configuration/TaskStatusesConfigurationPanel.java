...
public class TaskStatusesConfigurationPanel extends ConfigurationPanel implements PropertyChangeListener {
	...
	public TaskStatusesConfigurationPanel(ConfigurationGroup configurationGroup) {
	...
	private void initializeList() {
		...
		this.addButton = new TUAddButton(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event) {
				String status = JOptionPane.showInputDialog(
						TaskStatusesConfigurationPanel.this,
		...
		this.removeButton = new TURemoveButton(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent event) {
				for (Object value : TaskStatusesConfigurationPanel.this.list.getSelectedValues()) {
