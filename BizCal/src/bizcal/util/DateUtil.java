...
public class DateUtil {
	...
	/**
	 * Returns the date in distance to the given one, according to the offset
	 * (diff) given in days.<br/>
	 * Example:<br/>
	 * <strong>date =</strong> 2007-03-23 (Friday)<br/>
	...
	public static long getDiffMinutes(Date startDate, Date endDate) {
		...
		// }
		/* ------------------------------------------------------- */
		return (endDate.getTime() / MILLIS_MINUTE)
				- (startDate.getTime() / MILLIS_MINUTE);
		/* ====================================================== */
	}
