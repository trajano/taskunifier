 ...
 * @version
 * <br>
 *          $Log: CalendarDemo.java,v $ <br>
 *          Revision 1.8 2008/06/19 12:20:00 heine_ <br>
 *          *** empty log message *** <br>
 * <br>
 *          Revision 1.7 2008/06/09 14:10:09 heine_ <br>
 *          *** empty log message *** <br>
 * <br>
 *          Revision 1.6 2008/05/30 11:36:47 heine_ <br>
 *          *** empty log message *** <br>
 * <br>
 *          Revision 1.5 2008/04/08 13:17:53 heine_ <br>
 *          *** empty log message *** <br>
 * 
 */
public class CalendarDemo extends JFrame {
	...
	public CalendarDemo() {
		...
		// It will be informed of many interactions on the calendar like, event
		// selected
		...
		this.calendarPanel.addNamedCalendar(new TestNamedCalendar(
				...
				Color.GRAY));
		/* ------------------------------------------------------- */
		// next step is to create a listener that is responsible for selecting
		// and deselecting of
		...
		// A selected calendar is the calendar which will recieve the actions on
		// the view,
		...
		this.calendarPanel.addNamedCalendarListener(new NamedCalendarListener() {
			...
			public void selectedCalendarChanged(NamedCalendar selectedCalendar) {
				/* ====================================================== */
				// we do nothing here.
				// If you have any ideas of something that should be triggerd
				// when a calendar was selected...
				/* ====================================================== */
			}
	...
	private synchronized void updateEventsForActiveCalendars() {
		...
		for (NamedCalendar nc : this.calendarPanel.getCalendars()) {
			if (nc.isActive())
				// this is just for demonstration. You can define a time periode
				// to
	...
	class DemoCalendarListener implements CalendarListener {
		...
		public void eventSelected(Object id, Event event) throws Exception {
			...
			if (CalendarDemo.this.calendarPanel.getCalendars() == null)
				return;
			/* ------------------------------------------------------- */
			for (NamedCalendar nc : CalendarDemo.this.calendarPanel.getCalendars()) {
				if (nc.getId().equals(event.get(CALENDAR_ID))) {
					/* ------------------------------------------------------- */
					CalendarDemo.this.calendarPanel.setSelectedCalendar(nc);
					return;
					/* ------------------------------------------------------- */
				}
			}
		...
		@Override
		public void completeEvent(Event event) throws Exception {
			// TODO Auto-generated method stub
	 ...
	 *          *** empty log message *** <br>
	 * <br>
	 *          Revision 1.4 2008/03/28 08:45:12 heine_ <br>
	 *          *** empty log message *** <br>
	 * <br>
	 *          Revision 1.3 2008/01/21 14:14:17 heine_ <br>
	 *          code cleanup and java doc <br>
	 * <br>
	 *          Revision 1.17 2007/06/27 14:59:55 heinemann <br>
	 *          *** empty log message *** <br>
	 * <br>
	 *          Revision 1.16 2007/06/27 11:59:42 heinemann <br>
	 *          *** empty log message *** <br>
	 * 
	 */
