...
public class CheckBoxPanel extends JPanel implements ActionListener {
	...
	public CheckBoxPanel(String text, Color c, ButtonGroup group) {
		...
		this.button.setFont(this.button.getFont().deriveFont(10.0f));
		...
		if (c != null)
			this.button.setIcon(new ColorBoxIcon(c));
	...
	private synchronized void asynchInformActionListeners() {
		...
		for (Iterator iter = this.listeners.iterator(); iter.hasNext();) {
			...
			element.actionPerformed(new ActionEvent(
					this,
	 ...
	 * @version
	 * <br>
	 *          $Log: CheckBoxPanel.java,v $ <br>
	 *          Revision 1.5 2008/10/21 16:05:06 heine_ <br>
	 *          *** empty log message *** <br>
	 * <br>
	 *          Revision 1.4 2008/10/21 15:08:31 heine_ <br>
	 *          *** empty log message *** <br>
	 * 
	 */
	public class ColorBoxIcon implements Icon, UIResource, Serializable {
		...
		public int getIconWidth() {
			return (int) (this.getControlSize() * FAQ);
		}
