...
public class TextWrappingCellRenderer extends JTextArea implements TableCellRenderer {
	...
	public Component getTableCellRendererComponent(
		...
		this.setFont(new Font(this.getFont().getName(), Font.PLAIN, 10));
		
		this.setText((String) value);// or something in value, like
										// value.getNote()...
		this.setSize(
				p_Table.getColumnModel().getColumn(p_Column).getWidth(),
