 ...
 * @version
 * <br>
 *          $Log: TimeTracker.java,v $ <br>
 *          Revision 1.1 2008/06/12 13:04:36 heine_ <br>
 *          *** empty log message *** <br>
 * <br>
 *          Revision 1.1 2008-02-25 15:47:18 heinemann <br>
 *          Initial checkin <br>
 * 
 */
public class TimeTracker {
	 ...
	 * @param identifier
	 * @param hint
	 *            text to be placed in the output for simplification
	 */
	public static void lapTime(String identifier, String hint) {
		...
		try {
			...
			System.out.println("TimeTrack:: "
					...
					+ hint
					+ " : last operation took "
					+ (laps.get(laps.size() - 1) - laps.get(laps.size() - 2))
					+ "ms");
			// if ("17".equals(hint))
	...
	public static void finish(String identifier) {
		...
		System.out.println("TimeTrack:: "
				+ identifier
				+ ": Whole process took "
				+ (laps.get(laps.size() - 1) - laps.get(0))
				+ "ms");
		System.out.println("-------------------------------------------");
		/* ------------------------------------------------------- */
		// make clean
