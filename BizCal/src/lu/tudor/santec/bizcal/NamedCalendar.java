 ...
 * @version
 * <br>
 *          $Log: NamedCalendar.java,v $ <br>
 *          Revision 1.3 2008/04/08 13:17:53 heine_ <br>
 *          *** empty log message *** <br>
 * <br>
 *          Revision 1.2 2008/01/21 14:14:17 heine_ <br>
 *          code cleanup and java doc <br>
 * <br>
 *          Revision 1.9 2008-01-21 14:05:26 heinemann <br>
 *          code cleanup and java doc <br>
 * 
 */
public abstract class NamedCalendar {
	 ...
	 *            false means just saving without user interaction
	 */
	public abstract List<Event> saveEvent(
			String clientId,
			Event event,
