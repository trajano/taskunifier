...
public class SourceListControlBar {
	 ...
	 * divider of the given {@link JSplitPane}. Thus when the user drags the
	 * {@code SourceListControlBar} draggable widget, the given
	 * {@code JSplitPane}s divider location will be adjusted.
	 * 
	 * @param splitPane
	 ...
	 * {@code SourceListControlBar}. The returned {@link JComponent} should be
	 * added to a container that will be displayed.
	 * 
	 ...
	 * will be called just prior to each showing of the menu.
	 * 
	 * @param icon
