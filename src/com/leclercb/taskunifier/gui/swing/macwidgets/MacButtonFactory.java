...
public class MacButtonFactory {
	...
	public static AbstractButton makePreferencesTabBarButton(
	...
	static final ImagePainter GRADIENT_BUTTON_IMAGE_PAINTER = new ImagePainter(
			GRADIENT_BACKGROUND_URL);
	
	@SuppressWarnings("unchecked")
	private static final Painter<Component> PRESSED_AND_SELECTED_GRADIENT_PAINTER = new CompoundPainter<Component>(
			GRADIENT_BUTTON_IMAGE_PAINTER,
			new RectanglePainter(new Color(0, 0, 0, 89)));
	
	private static final ButtonStatePainter<AbstractButton> GRADIENT_BUTTON_PAINTER = new ButtonStatePainter<AbstractButton>(
			GRADIENT_BUTTON_IMAGE_PAINTER,
			GRADIENT_BUTTON_IMAGE_PAINTER,
	 ...
	 * depiction of a "Gradient style" button, depicted <a
	 * href="http://developer.apple.com/technotes/tn2007/tn2196.html#BUTTONS"
	 * >here</a>.
	 * 
	 ...
	 * 
	 * @param icon
	 *            the {@code Icon} to use in the button.
	 * @param actionListener
	 *            the {@code ActionListener} to notify when the created button
	 *            is pressed.
	 * @return a gradient-style button.
	 */
	public static EPButton createGradientButton(
			Icon icon,
	 ...
	 *            the {@code PopupMenuCustomizer} to be notified just prior to
	 *            the popup menu being shown.
	...
	public static PopdownButton createGradientPopdownButton(
		...
		PopdownButton popdownButton = new PopdownButton(
				icon,
				popupMenuCustomizer);
