...
public enum ActionList {
	...
	ADD_TEMPLATE_TASK(Translations.getString("action.add_template_task"), "template.png", true),
	BATCH_ADD_TASKS(Translations.getString(""), true),
	CHANGE_DATE_FOLDER_LOCATION(Translations.getString(""), false),
	CHANGE_VIEW(Translations.getString(""), true),
	CHANGE_VIEW_CALENDAR(Translations.getString(""), true),
	CHECK_PLUGIN_VERSION(Translations.getString(""), true),
	CHECK_VERSION(Translations.getString(""), true),
	COLLAPSE_ALL(Translations.getString(""), true),
	...
	POSTPONE_TASKS(Translations.getString(""), true),
