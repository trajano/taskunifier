...
public class ThemeConfigurationPanel extends ConfigurationPanel {
	...
	public void saveAndApplyConfig() {
		// Colors
		Settings.setBooleanProperty("theme.color.enabled",
				(Boolean) this.getValue("COLORS_ENABLED"));
		Settings.setColorProperty("theme.color.even",
				(Color) this.getValue("COLOR_EVEN"));
		Settings.setColorProperty("theme.color.odd",
				(Color) this.getValue("COLOR_ODD"));

		// Look And Feel & Theme
		LookAndFeelDescriptor previousLaf = LookAndFeelUtils
				.getLookAndFeel(Settings.getStringProperty("theme.lookandfeel"));
		LookAndFeelDescriptor laf = (LookAndFeelDescriptor) this
				.getValue("LOOK_AND_FEEL");
	...
	private void initialize() {
		...
		if (Settings.getStringProperty("theme.lookandfeel") != null)
			themeLookAndFeelValue = LookAndFeelUtils.getLookAndFeel(Settings
					.getStringProperty("theme.lookandfeel"));

		if (Settings.getBooleanProperty("theme.color.enabled") != null)
			themeColorEnabledValue = Settings
					.getBooleanProperty("theme.color.enabled");
		...
		this.addField(new ConfigurationField(
				...
				new ConfigurationFieldType.Label(Translations
						.getString("configuration.theme.look_and_feel_preview"))));
		...
		Collections.sort(lookAndFeels, new Comparator<LookAndFeelDescriptor>() {
			...
			@Override
			public int compare(LookAndFeelDescriptor laf1,
		...
		this.addField(new ConfigurationField("LOOK_AND_FEEL", Translations
				.getString("configuration.theme.look_and_feel"),
				new ConfigurationFieldType.ComboBox(lookAndFeels.toArray(),
		...
		this.addField(new ConfigurationField(
				...
				new ConfigurationFieldType.Label(
						Translations
								.getString("configuration.theme.colors_changed_after_restart"))));

		this.addField(new ConfigurationField("COLORS_ENABLED", Translations
				.getString("configuration.theme.colors_enabled"),
				new ConfigurationFieldType.CheckBox(themeColorEnabledValue)));

		this.addField(new ConfigurationField("COLOR_EVEN", Translations
				.getString("configuration.theme.color_even"),
				new ConfigurationFieldType.ColorChooser(themeColorEvenValue)));

		this.addField(new ConfigurationField("COLOR_ODD", Translations
				.getString("configuration.theme.color_odd"),
