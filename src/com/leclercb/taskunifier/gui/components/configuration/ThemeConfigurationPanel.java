...
public class ThemeConfigurationPanel extends ConfigurationPanel {
	...
	public void saveAndApplyConfig() {
		...
		// Look And Feel & Theme
		LookAndFeelDescriptor previousLaf = LookAndFeelUtils.getLookAndFeel(Settings.getStringProperty("theme.lookandfeel"));
	...
	private void initialize() {
		...
		this.addField(new ConfigurationField(
				...
				null, 
				new ConfigurationFieldType.Label(Translations.getString("configuration.theme.colors_changed_after_restart"))));
