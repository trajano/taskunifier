...
public class ThemeConfigurationPanel extends ConfigurationPanel {
	...
	public void saveAndApplyConfig() {
		...
		// Colors
		Settings.setBooleanProperty("theme.color.enabled", (Boolean) this.getValue("COLORS_ENABLED"));
		Settings.setColorProperty("theme.color.even", (Color) this.getValue("COLOR_EVEN"));
		Settings.setColorProperty("theme.color.odd", (Color) this.getValue("COLOR_ODD"));
	}
	...
	private void initialize() {
		...
		this.addField(new ConfigurationField("LOOK_AND_FEEL_PREVIEW", null, new ConfigurationFieldType.Label(
				Translations.getString("configuration.theme.look_and_feel_preview"))));

		this.addField(new ConfigurationField("COLOR_CHANGED_NEXT_STARTUP", null, new ConfigurationFieldType.Label(
		...
		this.addField(new ConfigurationField("COLOR_ODD", Translations.getString("configuration.theme.color_odd"),
