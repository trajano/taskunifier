...
public class TaskConfigurationPanel extends ConfigurationPanel {
	...
	public void saveAndApplyConfig() {
		...
		Settings.setStringProperty("task.default.title",
				(String) this.getValue("TITLE"));
		Settings.setStringProperty("task.default.tags",
		...
		Settings.setBooleanProperty("task.default.completed",
				(Boolean) this.getValue("COMPLETED"));
		Settings.setStringProperty("task.default.due_date",
				(String) this.getValue("DUE_DATE"));
		Settings.setStringProperty("task.default.start_date",
				(String) this.getValue("START_DATE"));
		Settings.setStringProperty("task.default.reminder",
				(String) this.getValue("REMINDER"));
		Settings.setStringProperty("task.default.repeat",
				(String) this.getValue("REPEAT"));
		Settings.setEnumProperty("task.default.repeat_from",
				TaskRepeatFrom.class,
				(TaskRepeatFrom) this.getValue("REPEAT_FROM"));
		Settings.setEnumProperty("task.default.status", TaskStatus.class,
				(TaskStatus) this.getValue("STATUS"));
		Settings.setEnumProperty("task.default.priority", TaskPriority.class,
				(TaskPriority) this.getValue("PRIORITY"));
		Settings.setBooleanProperty("task.default.star",
				(Boolean) this.getValue("STAR"));
		Settings.setStringProperty("task.default.note",
	...
	private void initialize() {
		...
		this.addField(new ConfigurationField("DEFAULT_VALUE", null,
				new ConfigurationFieldType.Label(Translations
						.getString("configuration.task.default_value"))));

		this.addField(new ConfigurationField("TITLE", Translations
				.getString("general.task.title"),
				new ConfigurationFieldType.TextField(taskTitleValue)));

		this.addField(new ConfigurationField("TAGS", Translations
				.getString("general.task.tags"),
				new ConfigurationFieldType.TextField(taskTagsValue)));

		this.addField(new ConfigurationField("FOLDER", Translations
				.getString("general.task.folder"),
				new ConfigurationFieldType.ComboBox(new FolderComboBoxModel(),
						taskFolderValue)));

		this.addField(new ConfigurationField("CONTEXT", Translations
				.getString("general.task.context"),
				new ConfigurationFieldType.ComboBox(new ContextComboBoxModel(),
						taskContextValue)));

		this.addField(new ConfigurationField("GOAL", Translations
				.getString("general.task.goal"),
				new ConfigurationFieldType.ComboBox(new GoalComboBoxModel(),
						taskGoalValue)));

		this.addField(new ConfigurationField("LOCATION", Translations
				.getString("general.task.location"),
				new ConfigurationFieldType.ComboBox(
						new LocationComboBoxModel(), taskLocationValue)));

		this.addField(new ConfigurationField("COMPLETED", Translations
				.getString("general.task.completed"),
				new ConfigurationFieldType.CheckBox(taskCompletedValue)));

		this.addField(new ConfigurationField("DUE_DATE", Translations
				.getString("general.task.due_date"),
				new ConfigurationFieldType.FormattedTextField(
						new RegexFormatter("^[0-9]{0,3}$"), taskDueDateValue)));

		this.addField(new ConfigurationField("START_DATE", Translations
				.getString("general.task.start_date"),
				new ConfigurationFieldType.FormattedTextField(
						new RegexFormatter("^[0-9]{0,3}$"), taskStartDateValue)));

		this.addField(new ConfigurationField("REMINDER", Translations
				.getString("general.task.reminder"),
				new ConfigurationFieldType.FormattedTextField(
						new RegexFormatter("^[0-9]{0,3}$"), taskReminderValue)));

		this.addField(new ConfigurationField("REPEAT", Translations
				.getString("general.task.repeat"),
				new ConfigurationFieldType.TextField(taskRepeatValue)));

		this.addField(new ConfigurationField("REPEAT_FROM", Translations
				.getString("general.task.repeat_from"),
				new ConfigurationFieldType.ComboBox(TaskRepeatFrom.values(),
						taskRepeatFromValue)));
		((ComboBox) this.getField("REPEAT_FROM").getType()).getFieldComponent()
				.setRenderer(new TaskRepeatFromListCellRenderer());

		this.addField(new ConfigurationField("STATUS", Translations
				.getString("general.task.status"),
				new ConfigurationFieldType.ComboBox(TaskStatus.values(),
						taskStatusValue)));
		((ComboBox) this.getField("STATUS").getType()).getFieldComponent()
				.setRenderer(new TaskStatusListCellRenderer());

		this.addField(new ConfigurationField("PRIORITY", Translations
				.getString("general.task.priority"),
				new ConfigurationFieldType.ComboBox(TaskPriority.values(),
						taskPriorityValue)));
		((ComboBox) this.getField("PRIORITY").getType()).getFieldComponent()
				.setRenderer(new TaskPriorityListCellRenderer());

		this.addField(new ConfigurationField("STAR", Translations
				.getString("general.task.star"),
				new ConfigurationFieldType.StarCheckBox(taskStarValue)));

		this.addField(new ConfigurationField("NOTE", Translations
				.getString("general.task.note"),
