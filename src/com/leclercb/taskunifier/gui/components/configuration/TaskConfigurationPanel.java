...
public class TaskConfigurationPanel extends ConfigurationPanel {
	...
	private void initialize() {
		...
		if (Settings.getEnumProperty("task.default.repeat_from", TaskRepeatFrom.class) != null)
			taskRepeatFromValue = (TaskRepeatFrom) Settings.getEnumProperty("task.default.repeat_from",
					TaskRepeatFrom.class);
		...
		this.addField(new ConfigurationField("DEFAULT_VALUE", null, new ConfigurationFieldType.Label(Translations
				.getString("configuration.task.default_value"))));

		this.addField(new ConfigurationField("TITLE", Translations.getString("general.task.title"),
				new ConfigurationFieldType.TextField(taskTitleValue)));

		this.addField(new ConfigurationField("TAGS", Translations.getString("general.task.tags"),
				new ConfigurationFieldType.TextField(taskTagsValue)));

		this.addField(new ConfigurationField("FOLDER", Translations.getString("general.task.folder"),
				new ConfigurationFieldType.ComboBox(new FolderComboBoxModel(), taskFolderValue)));

		this.addField(new ConfigurationField("CONTEXT", Translations.getString("general.task.context"),
				new ConfigurationFieldType.ComboBox(new ContextComboBoxModel(), taskContextValue)));

		this.addField(new ConfigurationField("GOAL", Translations.getString("general.task.goal"),
				new ConfigurationFieldType.ComboBox(new GoalComboBoxModel(), taskGoalValue)));

		this.addField(new ConfigurationField("LOCATION", Translations.getString("general.task.location"),
				new ConfigurationFieldType.ComboBox(new LocationComboBoxModel(), taskLocationValue)));

		this.addField(new ConfigurationField("COMPLETED", Translations.getString("general.task.completed"),
				new ConfigurationFieldType.CheckBox(taskCompletedValue)));

		this.addField(new ConfigurationField("DUE_DATE", Translations.getString("general.task.due_date"),
				new ConfigurationFieldType.FormattedTextField(new RegexFormatter("^[0-9]{0,3}$"), taskDueDateValue)));

		this.addField(new ConfigurationField("START_DATE", Translations.getString("general.task.start_date"),
				new ConfigurationFieldType.FormattedTextField(new RegexFormatter("^[0-9]{0,3}$"), taskStartDateValue)));

		this.addField(new ConfigurationField("REMINDER", Translations.getString("general.task.reminder"),
				new ConfigurationFieldType.FormattedTextField(new RegexFormatter("^[0-9]{0,3}$"), taskReminderValue)));

		this.addField(new ConfigurationField("REPEAT", Translations.getString("general.task.repeat"),
				new ConfigurationFieldType.TextField(taskRepeatValue)));

		this.addField(new ConfigurationField("REPEAT_FROM", Translations.getString("general.task.repeat_from"),
		...
		this.addField(new ConfigurationField("STATUS", Translations.getString("general.task.status"),
		...
		this.addField(new ConfigurationField("PRIORITY", Translations.getString("general.task.priority"),
		...
		this.addField(new ConfigurationField("STAR", Translations.getString("general.task.star"),
				new ConfigurationFieldType.StarCheckBox(taskStarValue)));

		this.addField(new ConfigurationField("NOTE", Translations.getString("general.task.note"),
